...
int main(void)
{
	...
	printf("ft_recursive_power(2, 5): %d\n", ft_recursive_power(2, 5));
	printf("ft_recursive_power(2, 6): %d\n", ft_recursive_power(2, 6));
	printf("ft_recursive_power(2, 7): %d\n", ft_recursive_power(2, 7));
	printf("ft_recursive_power(2, 8): %d\n", ft_recursive_power(2, 8));
	printf("ft_recursive_power(2, 9): %d\n", ft_recursive_power(2, 9));
